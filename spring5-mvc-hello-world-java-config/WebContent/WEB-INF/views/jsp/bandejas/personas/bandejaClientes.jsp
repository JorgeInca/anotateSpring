...
<body>
	...
	<div class="row">
		...
		<div class="col col-md-2 offset-md-3">
			<button type="button" class="btn btn-warning"
				onclick="PersonasJS.nuevoCliente()">
				<span style="color: white;"> <i class="fas fa-plus"></i>Nuevo
				</span>
			</button>
		</div>
		<p>
	...
	<%@ include file="modal/modalCliente.jsp"%>
	<%@ include file="modal/modalEliminaCliente.jsp"%>
...
<script
	src="${pageContext.request.contextPath}/resources/js/tools/popper.min.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/bootstrap.min.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/datatable/jquery.dataTables.min.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/tools/moment.min.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/daterangepicker/daterangepicker.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/general.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/bandejas/bandejaGeneral.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/personas/personas.js"></script>

<script type="text/javascript">
	tablaGlobal = $('#tableClientes').DataTable({
		columns : [
		// { mData: "id" },
		{
			mData : "nombre"
...
<script>
	...
	$("#fechaNac").change(
			function() {
				var dateParts = $("#fechaNac").val().split("/");
				var edad = moment()
						.diff(
