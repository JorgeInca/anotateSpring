  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title"><div id="titleModalEmpleado"></div></h4>
      ...
      <div class="modal-body">
		...
		<div class="row" >
	    	<div class="col-md-4 form-group" >
		      <label class="control-label col-sm-2" for="pwd">Numero Empleado:</label>
		    </div>
		    <div class="col-md-6 col-md-offset-2 form-group">          
		       <input type="text" class="form-control" id="numeroEmpleado" name="numeroEmpleado" maxlength="140">
		    </div>
		</div>
		<input id="tipoOperacion" type="text"  hidden>
		<input id="idEmpleado" type="text"  hidden>
		<div id="divError" class="alert alert-danger" role="alert" ></div>	
	  </div>

      <!-- Modal footer -->
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" onClick="PersonasJS.limpiaModalEmpleado();">
      			<span style="color: white;">Limpiar</span>
		</button>
      	<button type="button" class="btn btn-success"  onClick="PersonasJS.validaGuardaEmpleado();"><div id="btnModalEmpleado"></div></button>
